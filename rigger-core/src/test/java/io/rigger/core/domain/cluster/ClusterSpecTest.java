...
class ClusterSpecTest {
    SshCredentials ssh() { return SshCredentials.of("ubuntu","~/.ssh/id"); }
    ClusterDefaults defaults() { return new ClusterDefaults(ssh()); }
    ...
    @Test void resolveCredentials_nodeOverrideWins() {
